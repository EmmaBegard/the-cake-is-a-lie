...
class player :
    ...
    """def Espaces(self):   #an amelioration we could make later
        ...
        with open(self.message, 'r') as mon_fichier:
            ...
            while b!=1:
                ...
                if self.lignes[0][n] or self.lignes[1][0]==" ":
                    b=1
                    print("works")"""
    ...
    def texte(self):
        ...
        if self.t==1 :
            ...
            if self.message == "vieux_quete.txt" :
                self.arme = 1
