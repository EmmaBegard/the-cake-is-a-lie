...
class player :
    ...
    def hit(self):
        ...
        walkRight = [pygame.image.load('RIP.png')]
        walkLeft = [pygame.image.load('RIP.png')]
        walkUp = [pygame.image.load('RIP.png')]
        walkDown = [pygame.image.load('RIP.png')]
        charUP = pygame.image.load('RIP.png')
        charDOWN = pygame.image.load('RIP.png')
    ...
    def backGround(self):
        ...
        if self.zone == 'desert_1.png':

            if self.x < 0:
                # changing the character zone and so the background
                self.zone = 'sand_village.png'
                self.x = 1259
                self.y = self.y
                ...
                # changing the character zone and so the background
                self.zone = 'sand_oasis.png'
                # we put the character at the top of the new area
                self.x = self.x
                self.y = 0

        elif self.zone == 'desert_2.png':
            ...
            if self.x > 1260:
                ...
                self.zone = 'foret_desert.png'
                self.x = 1210
                self.y = self.y

         # displaying the right background
        elif self.zone == 'sand_village.png':

            if self.x > 1260:
                # changing the character zone
                self.zone = 'desert_1.png'
                # we put the character at the top of the new area
                self.x = 5
                self.y = self.y
        ...
        elif self.zone == "sand_maison_2.png":
        ...
        #FORET
        ...
        elif self.zone == 'foret_desert.png':
            ...
            if self.x > 1260:
                ...
                self.zone = 'foret_road.png'
                self.x = self.x
                self.y = 600

        elif self.zone == 'foret_road.png':
            ...
            # to the area fleuve _ 1
                ...
                self.zone = 'foret_fontaine.png'
                self.x = 1210
                self.y = self.y


        elif self.zone == 'foret_fontaine.png':
        ...
        elif self.zone == 'foret_village.png':
            ...
            if self.y > 264 and self.y < 280 and self.x < 632 and self.x > 560 and keys[pygame.K_w] : #enter old man's house
                self.zone = "maison_vieux.png"
                self.y = 630
                self.x = self.x

        elif self.zone == "maison_vieux.png" :
        ...
        #FLEUVE
            ...
            if self.x >720 and self.x < 781 and self.y > 640 :
                ...
                self.zone = 'fleuve_2.png'
                self.x = self.x
                self.y = 640

            elif self.x > 1200:
                self.zone = 'montagne_1.png'
                self.x = 22
                self.y = self.y



        elif self.zone == 'fleuve_2.png':
            if self.x < 20 :
                self.zone = 'fleuve_3.png'
                self.x = 1190
                self.y = self.y
        ...
        elif self.zone == 'fleuve_3.png':

            if self.y > 640 :
                self.zone = 'fleuve_village.png'
                self.x = self.x
                self.y = 3
        ...
        elif self.zone == 'fleuve_village.png':
            if self.y < 2 :
                self.zone = 'fleuve_3.png'
                self.x = self.x
                self.y = 635
                ...
                self.zone = "fleuve_maison_1.png"
                self.x = 644
                self.y = 620

            elif self.x > 120 and self.x < 208 and self.y > 516 and self.y < 590 and keys[pygame.K_w] :
                self.zone="fleuve_maison_2.png"
                self.x = 644
                self.y = 620



        elif self.zone =="fleuve_maison_1.png":
        ...
        elif self.zone == "fleuve_maison_2.png":
        ...
        #MONTAGNE
            ...
            if self.y > 645:
                ...
                self.zone = "montagne_volcan.png"
                self.x = 11
                self.y = self.y

        elif self.zone == "montagne_volcan.png":
            if self.x < 10:
                ...
                self.zone = "montagne_village.png"
                self.x = self.x
                self.y = 4

        elif self.zone == "montagne_village.png":
            if self.y < 2:
                self.zone = "montagne_volcan.png"
                self.x = self.x
                self.y = 640

        elif self.zone == "montagne_1.png" :
    ...
    def foret_village (self):
        ...
        if keys[pygame.K_LEFT]:   #POUR ALLER A GAUCHE
            ...
            if self.x > 216 and self.x < 245 and self.y > 473 and self.y < 570 :  #limite marchand + maisons
                ...
                self.y = self.y
                if self.a_d == 0 :
                    self.message = "marchand_f.txt"
                else :
                    self.message ="marchand_arme.txt"
    ...
    def maison_vieux(self):
        ...
        if keys[pygame.K_LEFT]:
            ...
            if self.x <32 and self.x > 16 and self.y < 652 and self.y > 406 : #bordure left
                ...
                if self.arme == 0:
                    self.message="vieux_quete.txt"
                    self.a_d = 1 #variabl demande arme
                else :
                    self.message="vieux_quete2.txt"
                self.dia = 1
                self.y = self.y
                self.x = self.x
    ...
    def foret_fontaine(self):
        ...
        # if we want to to on the left
            ...
            #the limit of the wall
                ...
                self.not_move()
                self.message = "chevalier_porte.txt"
                self.dia = 1
    ...
    def fleuve_maison_2(self):
        ...
        if keys[pygame.K_LEFT]:
            ...
            # the table and bench
                ...
                self.not_move()
                self.message = "fleuve_marchand.txt"
                self.dia = 1
    ...
    def fleuve_maison_1(self):
        ...
        if keys[pygame.K_LEFT]:
            ...
            # the table and chairs
                ...
                self.not_move()
                self.message = "fleuve_goddess.txt"
                self.dia = 1
    ...
    def montagne_village(self):
        ...
        if keys[pygame.K_LEFT]:
            ...
            # the old man mansion
            if self.x > 690 and self.x < 730 and sefl.y > 22 and self.y < 286 :
                self.not_move()
        ...
        # if we want to go on the right
            ...
            # the old man mansion
            if self.x > 448 and self.x < 504 and sefl.y > 28 and self.y < 276 :
                self.not_move()
        ...
        # if we want to to on the left
            ...
            if self.x > 448 and self.x < 560 and sefl.y > 236 and self.y < 276 :
                self.not_move()

            # the old man door on the right
            elif self.x > 640 and self.x < 714 and sefl.y > 236 and self.y < 276 :
                self.not_move()
    ...
    def texte(self):
        ...
        if self.t==1 :
            ...
            self.bloc=pygame.image.load("texte.png")
    ...
    def Long(self):
        ...
        if self.i==self.n3:
            ...
            if self.message == "marchand_arme.txt" :
                self.arme = 1
            if self.message == "fleuve_goddess.txt" :
                self.mission1 = 1
