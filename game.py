...
dog1 = dog(533,272,"foret_road.png",1125-533, 138, 83, 3)

fish1 = fish(1280,360,"fleuve_1.png",1280, 64, 37, 3)

# the bee enemies
bee1 = bee(1000, 600,"fleuve_2.png",600, 32, 32, 3)
bee2 = bee(800, 700,"fleuve_2.png",700, 32, 32, 3)
bee3 = bee(1100, 800,"fleuve_2.png",800, 32, 32, 3)
bee4 = bee(400, 650,"fleuve_2.png",650, 32, 32, 3)

# the octopus enemies
octopus1 = octopus(400, 700,"fleuve_3.png",800, 82, 82, 3)
octopus2 = octopus(0, 800,"fleuve_3.png",900, 82, 82, 3)
octopus3 = octopus(200, 650,"fleuve_3.png",750, 82, 82, 3)

# the goblin enemies
goblin_1 = goblin( 500, 300, 'desert_1.png',  600, 64, 64, 3)
goblin_2 = goblin(500, 300, 'desert_2.png', 600, 64, 64, 3)
